...
2. **Squad composition:** 2 backend + 2 frontend engineers, 1 QA engineer, 1 product designer, 1 Product Owner (7 delivery members), plus the incoming Scrum Master (facilitation only, not counted in delivery capacity). The remote contractor is one of the four engineers.
3. **Remote contractor's timezone:** 5 hours behind Lagos (WAT, UTC+1) — treated as equivalent to US Eastern-adjacent hours for scheduling purposes. Overlap window used throughout: **2:00–4:00pm Lagos / 9:00–11:00am contractor time.**
